...
void draw() 
{
  ...
  { 
    ...
    {  
      ...
      a = serial;  //a new array (called 'a') that stores values into separate cells (separated by commas specified in your Arduino program)
      println(a); //print LDR value
...
void function()
{
  if ( msql.connect() )
    {
        msql.query( "insert into data(UID)values('"+a+"')" );
    }
    else
    {
        // connection failed !
